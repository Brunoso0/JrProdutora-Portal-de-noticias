...
import ProtectedRouteJudge from "./shared/components/ProtectedRouteJudge";
  ...
  return (
    <UserProvider>
      ...
      <Routes>
        ...
        <Route path="/festival-forro/jurado" element={<ProtectedRouteJudge><JudgeArea /></ProtectedRouteJudge>} />
